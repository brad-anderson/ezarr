...
sudo mkdir -pv docker/{sonarr,radarr,lidarr,readarr,mylar,prowlarr,qbittorrent,bazarr,sabnzbd}-config
sudo mkdir -pv data/{torrents,usenet,media}/{tv,movies,music,books,comics}
